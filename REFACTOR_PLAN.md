...
14. *(If PR 2 ships)* **Atomic swap self-heal:** two region roles by hand, one reaction → exactly one region role afterward; a managed booster role survives the swap.
